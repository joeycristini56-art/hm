...
/* iOS Detection */
    ...
    #elif TARGET_OS_MAC
        /* macOS is not officially supported but can be used for development */
        #define XORON_PLATFORM_MACOS 1
        #define XORON_PLATFORM_NAME "macOS"
        #define XORON_LIBRARY_EXTENSION ".dylib"
    #endif
#endif
...
#if !defined(XORON_PLATFORM_IOS) && !defined(XORON_PLATFORM_ANDROID) && !defined(XORON_PLATFORM_MACOS)
