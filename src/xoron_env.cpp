...
#if defined(XORON_PLATFORM_IOS) || defined(__APPLE__)
    /* Check if Roblox is the frontmost application */
    id workspace = ((id(*)(Class, SEL))objc_msgSend)(
        objc_getClass("NSWorkspace"), sel_registerName("sharedWorkspace"));
    id frontApp = ((id(*)(id, SEL))objc_msgSend)(
        workspace, sel_registerName("frontmostApplication"));
    id bundleId = ((id(*)(id, SEL))objc_msgSend)(
        frontApp, sel_registerName("bundleIdentifier"));
    
    if (bundleId) {
        const char* bid = ((const char*(*)(id, SEL))objc_msgSend)(
            bundleId, sel_registerName("UTF8String"));
        if (bid && (strstr(bid, "roblox") || strstr(bid, "Roblox"))) {
            lua_pushboolean(L, true);
            return 1;
        }
    }
...
static int lua_setclipboard(lua_State* L) {
    ...
    id array = ((id(*)(Class, SEL, id))objc_msgSend)(
        objc_getClass("NSArray"), sel_registerName("arrayWithObject:"), nsstring);
    
    ((BOOL(*)(id, SEL, id))objc_msgSend)(
        pasteboard, sel_registerName("writeObjects:"), array);
...
static int lua_getclipboard(lua_State* L) {
    ...
    id types = ((id(*)(Class, SEL, id))objc_msgSend)(
        objc_getClass("NSArray"), sel_registerName("arrayWithObject:"),
        ((id(*)(Class, SEL))objc_msgSend)(objc_getClass("NSString"), sel_registerName("class")));
    
    id objects = ((id(*)(id, SEL, id, id))objc_msgSend)(
        pasteboard, sel_registerName("readObjectsForClasses:options:"), types, nil);
    
    if (objects && ((NSUInteger(*)(id, SEL))objc_msgSend)(objects, sel_registerName("count")) > 0) {
        id str = ((id(*)(id, SEL, NSUInteger))objc_msgSend)(
            objects, sel_registerName("objectAtIndex:"), 0);
